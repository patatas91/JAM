...
public class MessageBox extends MessageBoxNoSync implements RemoteMessageBox {
	 ...
	 * @throws InterruptedException
	 */
	synchronized public Message readMessage(AgentID agentID) throws InterruptedException {
		Message m = null;
		while (super.readMessage(agentID) == null) {
                wait();
            }
	 ...
	 * @throws InterruptedException
	 */
	synchronized public Message readMessage(Performative performative) throws InterruptedException {
		Message m = null;
		while (super.readMessage(performative) == null) {
                wait();
            }
	...
	synchronized public Message readMessage(AgentID agentID,
		...
		Message m = null;
		while (super.readMessage(agentID, performative) == null) {
                wait();
            }
	 ...
	 * @return boolean
	 */
	synchronized public boolean isThereMessage(AgentID agentID, Performative performative) {
